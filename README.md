...
- Определила связанные функции: функцию модели, функцию потерь, функцию оптимизации.
- Выполнила шаги 1-6 (скриншоты в папке задание2). Из скриншотов заметна прямая зависимость между увеличением значения параметра и точностью графика. При низких значениях параметра график случайным образом отклоняется от точек.
